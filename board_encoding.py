...
class BoardEncoding(gym.ObservationWrapper):
    ...
    referred to as the board's "history", grouped into sets of 14 planes per
    ...
    castling rights for the active player and her opponent (king-side and
    queen-side, respectively), and lastly, the half-move-clock.
